...
@Module({
  ...
  controllers: [AddAccountController, SearchAccountController, RemoveAccountController, SetPermissionsController],
  providers: [AddAccountUseCase, SearchAccountUseCase, RemoveAccountUseCase, AccountService, getAccountRepo(), SetPermissionsUseCase],
