...
@Module({
  imports: [],
  controllers: [AddProductCategoryController, SearchProductCategoryController, RemoveProductCategoryController, UpdateProductCategoryController, MoveProductCateogoryController],
  providers: [AddProductCategoryUseCase, SearchProductCategoryUseCase, RemoveProductCategoryUseCase, UpdateProductCategoryUseCse, MoveProductCategoryUseCase, ProductCategoryService, getProductCategoryRepo()],
