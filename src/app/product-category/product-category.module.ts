...
@Module({
  imports: [],
  controllers: [AddProductCategoryController, SearchProductCategoryController, RemoveProductCategoryController, UpdateProductCategoryController, MoveProductCateogoryController, SubProductCategoriesController],
  providers: [AddProductCategoryUseCase, SearchProductCategoryUseCase, RemoveProductCategoryUseCase, UpdateProductCategoryUseCse, MoveProductCategoryUseCase, ProductCategoryService, SubProductCategoriesUseCase, getProductCategoryRepo()],
