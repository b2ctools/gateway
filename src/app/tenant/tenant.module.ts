...
@Module({
  imports: [],
  controllers: [AddTenantController, SearchTenantController, RemoveTenantController, UpdateTenantController],
  providers: [AddTenantUseCase, SearchTenantUseCase, RemoveTenantUseCase, UpdateTenantUseCse, TenantService, getTenantRepo()],
