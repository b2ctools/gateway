...
import { PermissionDto, sortable, permissionToDto } from '../../domain/permission.interface';
...
export class SearchPermissionController {
  ...
  @Get()
  async findAllPermissions(@Query() request: SearchRequest): Promise<SearchOutput<PermissionDto>> {
