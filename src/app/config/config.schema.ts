...
export const envVarValues = {
    ...
    JWT_ACCESS_EXPIRE_TIMESTAMP: parseInt(process.env.JWT_ACCESS_EXPIRE_TIMESTAMP),
    JWT_REFRESH_EXPIRE: process.env.JWT_REFRESH_EXPIRE,
    JWT_REFRESH_EXPIRE_TIMESTAMP: parseInt(process.env.JWT_REFRESH_EXPIRE_TIMESTAMP),
    JWT_RECOVERY_EXPIRE: process.env.JWT_RECOVERY_EXPIRE,
    JWT_RECOVERY_EXPIRE_TIMESTAMP: parseInt(process.env.JWT_RECOVERY_EXPIRE_TIMESTAMP),
